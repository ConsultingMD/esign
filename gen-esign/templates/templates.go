...
package {{.Package}} // import "github.com/ConsultingMD/esign{{.PackagePath}}/{{.Package}}"
...
package {{.ModelPackage}} // import "github.com/ConsultingMD/esign/{{.ModelPackagePath}}{{else}}package {{.ModelPackage}}
{{end}}{{if .ModelImports}}
